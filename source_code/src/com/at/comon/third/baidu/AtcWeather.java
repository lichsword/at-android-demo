    ...
    public void requestWeather(final Callback callback) {
        ...
        thread.execute(TAG, null, new Runnable() {
            ...
            public void run() {
                ...
                ATHttpParameter[] parameter = new ATHttpParameter[] { new ATHttpParameter("location", "武汉"), new ATHttpParameter("output", "json"),
                        new ATHttpParameter("ak", "BDEEPt05z9g4YAR0c6629KYk") };

                try {
                    ATHttpResponse response = httpClient.get("http://api.map.baidu.com/telematics/v3/weather", parameter);
